# R Code from James with a few alterations.
# This does not return the density.
...
# Run the Gibbs when beta, sig2, and tau are to be estimated.
...
# Implicitly using an uniformative prior.
